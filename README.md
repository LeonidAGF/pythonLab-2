...
- Cообщения об ошибках не выводятся в консоль, а сохраняются только в shell.log

- Путь до файла или католога не должен содержать пробелов.

- Названия файлов и каталогов могут содержать латинские и русские буквы, цифры и такие символы как - _ / * ? < > ( ) | { } + ! @ # $ % ^ &.
